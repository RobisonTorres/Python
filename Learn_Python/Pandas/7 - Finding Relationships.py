...
# If you don't use the '.to_string' it won't print all the values.

# The corr() method calculates the relationship between
# each column in your data set.
correlation = my_csv.corr()
print(correlation)

'''
Result Explained
The Result of the corr() method is a table with a lot of 
numbers that represents how well the relationship is between two columns.
...
is safe to say you have to have at least 0.6 (or -0.6) to call it 
a good correlation.
